...
const Nav = () => {
  ...
  return (
    <nav className="flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 xl:right-[2%] mt-auto z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
